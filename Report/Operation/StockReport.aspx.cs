...
namespace Report.Operation
{
    public partial class StockReport : System.Web.UI.Page
    {
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "SELECT  ST.id, ST.ticket_no, ST1.ticket_no as pre_ticket_no, ST.ticket_type,ST.serial_number,ST1.serial_number pre_serial_number, ST.contract_no, CT.customer_name, CLT.coll_type_name " +
                ...
                " LEFT JOIN(SELECT contract_id, SUM(principle_less) principle_less FROM schedule_ticket WHERE ticket_status != 'P'  GROUP BY contract_id) OUS ON ST.contract_id = OUS.contract_id " +
