...
namespace Report.Operation
{
    public partial class LateReport : System.Web.UI.Page
    {
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            var lateReportSql = "SELECT CUS.customer_name,P.lob_name,C.disbursement_date,OUS.principle_less,C.interest_rate,A.id,A.contract_id,A.contract_no,A.ticket_no,A.created_date, " +
