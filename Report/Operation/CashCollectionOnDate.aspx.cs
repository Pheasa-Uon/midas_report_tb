...
namespace Report.Operation
{
    public partial class CashCollectionOnDate : System.Web.UI.Page
    {
        ...
        {
            var spd = "PS_CASH_COLLECTION_ON_DATE";
        ...
        private void GenerateReport(DataTable dt)
        {
            ...
            var ds = new ReportDataSource("CCOnDate", dt);
            DataHelper.generateOperationReport(ReportViewer1, "CashCollectionOnDate", reportParameters, ds);
        }
    }
}