        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-3 form-group">
                    <label>Branch:</label>
                    <asp:DropDownList ID="ddBranchName" runat="server" AutoPostBack="true" CssClass="form-control input-sm"></asp:DropDownList>
                ...
                <div class="col-sm-2 form-group">
                  ...
                  <div class="col-sm-2 form-group">
                            ...
                            <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control input-sm" Enabled="true">
                            </asp:DropDownList>
                </div>
