<%@ Page Title="BranchProductivity As Of" MasterPageFile="~/Site.Master" Language="C#" AutoEventWireup="true" CodeBehind="BranchProductivityAsOf.aspx.cs" Inherits="Report.Operation.BranchProductivityAsOf" %>
            ...
            <div class="form-inline">
                <div class="form-group">
                   ...
                   <div class="form-group ml16">
                            ...
                            <asp:DropDownList ID="ddCurrency" runat="server" CssClass="form-control cnt-min-width" Enabled="false">
                            </asp:DropDownList>
                </div>
                <div class="form-group ml16">
